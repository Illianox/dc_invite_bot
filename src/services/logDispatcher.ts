...
function logTitle(eventType: string): string {
  const titles: Record<string, string> = {
    ...
    referral_reward_check_error: "Fehler bei Spielerwerbungs-Prüfung",
